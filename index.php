...
<body>
    ...
    <div class="body-section">
        <div class="container">
            ...
            <div>
                ...
                <button><a href="vacancies.php">Find vacancies.</a></button>
            </div>
        </div>
    </div>
    <div class="blog-section">
        <div class="container">
            <div>
                <h1>Join the community of world's best remote engineers</h1>
                ...
                <button><a href="blog.php">Join our blog!!</a></button>
            </div>
